...
@section('title', 'Buat Artikel Konservasi Laut Baru')
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="text-center mb-6 fade-in-up">
            ...
            <div class="inline-flex items-center bg-white/15 backdrop-blur-md rounded-full px-6 py-2 mb-4 animate-on-scroll border border-white/20">
                ...
                <span class="text-cyan-100 font-medium">Berbagi Pengetahuan Konservasi</span>
            </div>

            <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 underwater-text-effect">
                Buat <span class="gradient-text-enhanced">Artikel Konservasi</span>
            </h1>
            <p class="text-lg text-cyan-100 max-w-2xl mx-auto">
                Bagikan pengetahuan dan pengalaman Anda untuk membentuk pemahaman yang lebih baik tentang konservasi laut
            </p>
        </div>
    </div>
...
<section class="py-12 bg-gradient-to-b from-cyan-50 via-white to-blue-50 relative">
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-cyan-100 p-6 md:p-8 hover-lift mb-10">
                <form action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <!-- Title -->
                    <div>
                        <label for="judul" class="block text-gray-800 font-medium mb-2 items-center">
                    ...
                    <!-- Category -->
                    <div>
                        <label for="category_id" class="block text-gray-800 font-medium mb-2  items-center">
                            <svg class="w-5 h-5 mr-2 text-cyan-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Tags -->
                    <div>
                        <label class="block text-gray-800 font-medium mb-2 items-center">
                            <svg class="w-5 h-5 mr-2 text-cyan-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Content -->
                    <div>
                        <label for="konten_isi_artikel" class="block text-gray-800 font-medium mb-2  items-center">
                            <svg class="w-5 h-5 mr-2 text-cyan-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <textarea name="konten_isi_artikel" id="konten_isi_artikel" rows="12"
                            class="w-full border-cyan-200 focus:border-cyan-500 focus:ring focus:ring-cyan-200 rounded-xl shadow-sm transition-all duration-300"
                            placeholder="Tulis artikel konservasi laut Anda di sini..." required>{{ old('konten_isi_artikel') }}</textarea>
                        <p class="text-sm text-gray-500 mt-1">
                    ...
                    <!-- Image Upload -->
                    <div>
                        <label for="gambar" class="block text-gray-800 font-medium mb-2 items-center">
                            <svg class="w-5 h-5 mr-2 text-cyan-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <p class="text-sm text-gray-500 mt-2">
        Unggah gambar utama untuk artikel (JPG, PNG, JPEG - maks. 2MB). Gambar yang menarik akan meningkatkan daya tarik artikel Anda.
                    ...
                    <!-- Submit Buttons -->
                    <div class="flex flex-col sm:flex-row items-center justify-end gap-4 mt-10 border-t border-cyan-100 pt-6">
                        <a href="{{ route('articles.store') }}" class="w-full sm:w-auto bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium py-3 px-8 rounded-xl transition duration-300 flex items-center justify-center">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Article Guidelines -->
            <div class="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-2xl overflow-hidden shadow-lg border border-cyan-100 hover-lift">
                <div class="bg-gradient-to-r from-cyan-600 to-blue-600 px-6 py-4">
                    <h3 class="text-xl font-bold text-white flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        Panduan Menulis Artikel Konservasi
                    </h3>
                </div>
                <div class="p-6">
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            <div class="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 flex items-center justify-center mr-3 mt-0.5 shadow-md">
                                <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                </svg>
                            </div>
                            <div>
                                <h4 class="text-gray-800 font-medium">Berbagi Informasi Faktual</h4>
                                <p class="text-gray-600">Pastikan informasi yang Anda bagikan akurat dan didukung oleh data atau penelitian ilmiah terpercaya.</p>
                            </div>
                        </li>
                        <li class="flex items-start">
                            <div class="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 flex items-center justify-center mr-3 mt-0.5 shadow-md">
                            ...
                            <div>
                                <h4 class="text-gray-800 font-medium">Konten Orisinal</h4>
                                <p class="text-gray-600">Artikel yang Anda tulis harus merupakan karya asli yang menambah nilai pada komunitas konservasi laut.</p>
                            </div>
                        </li>
                        <li class="flex items-start">
                            <div class="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 flex items-center justify-center mr-3 mt-0.5 shadow-md">
                            ...
                            <div>
                                <h4 class="text-gray-800 font-medium">Struktur yang Baik</h4>
                                <p class="text-gray-600">Gunakan paragraf pendek, sub-judul, dan poin-poin untuk membuat artikel Anda mudah dibaca dan dipahami.</p>
                            </div>
                        </li>
                        <li class="flex items-start">
                            <div class="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 flex items-center justify-center mr-3 mt-0.5 shadow-md">
                            ...
                            <div>
                                <h4 class="text-gray-800 font-medium">Tinjauan Moderator</h4>
                                <p class="text-gray-600">Artikel Anda akan ditinjau oleh moderator sebelum dipublikasikan untuk memastikan kesesuaian dengan panduan komunitas.</p>
                            </div>
                        </li>
                    </ul>
                    ...
                    <div class="mt-6 p-4 bg-blue-50 border-l-4 border-blue-500 rounded">
                        <p class="text-blue-800 flex items-start">
                            ...
                            Artikel tentang konservasi laut merupakan kontribusi penting dalam upaya pelestarian ekosistem laut. Terima kasih atas partisipasi Anda!
                        </p>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add keyframe animation for bubble float
