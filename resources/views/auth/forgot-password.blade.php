...
@section('title', 'Lupa Kata Sandi - Portal Lautan Bagan')
    ...
    <div class="relative z-10 w-full max-w-md px-8 py-10">
        <div class="bg-white/10 backdrop-blur-xl rounded-3xl overflow-hidden shadow-2xl border border-white/20 transform transition-all hover:shadow-cyan-500/20 kartu-bercahaya">
            ...
            <div class="text-center pt-10 pb-6 px-8">
                ...
                <h2 class="text-3xl font-bold text-white mb-1 tracking-wide">Lupa Kata Sandi</h2>
                <p class="text-cyan-100 text-lg">Masukkan email Anda untuk mendapatkan tautan pemulihan</p>
            </div>
            ...
            <div class="px-8 pt-6 pb-8">
                <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                    ...
                    <!-- Tombol Submit -->
                    <div class="transform transition duration-500 item-form-masuk" style="transition-delay: 100ms">
                ...
                <div class="mt-8 text-center transform transition duration-500 item-form-masuk" style="transition-delay: 200ms">
        ...
        <!-- Fakta Lautan -->
        <div class="mt-8 text-center transform transition duration-500 item-form-masuk bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10" style="transition-delay: 300ms">
            <div class="flex items-start">
                ...
                <p class="text-sm text-cyan-100 text-left">
                    <span class="font-medium text-white">Fakta Lautan:</span> Air laut menyimpan panas lebih baik daripada udara, membuat lautan menjadi penyeimbang penting suhu bumi dan iklim global kita.
                </p>
            </div>
        </div>
    </div>
