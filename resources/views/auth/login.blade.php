...
@section('title', 'Masuk - Portal Lautan Bagan')
    ...
    <div class="relative z-10 w-full max-w-md px-8 py-10">
        <div class="bg-white/10 backdrop-blur-xl rounded-3xl overflow-hidden shadow-2xl border border-white/20 transform transition-all hover:shadow-cyan-500/20 kartu-bercahaya">
            ...
            <div class="text-center pt-10 pb-6 px-8">
                ...
                <h2 class="text-3xl font-bold text-white mb-1 tracking-wide">Selamat Datang Kembali</h2>
                <p class="text-cyan-100 text-lg">Masuk ke portal lautan Anda</p>
            </div>
            ...
            <div class="px-8 pt-6 pb-8">
                <form action="{{ route('login') }}" method="POST" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between transform transition duration-500 item-form-masuk" style="transition-delay: 200ms">
                        <div class="flex items-center">
                            <input id="ingatkan" name="ingatkan" type="checkbox" {{ old('ingatkan') ? 'checked' : '' }}
                                class="h-5 w-5 rounded border-white/20 bg-white/10 text-cyan-500 focus:ring-cyan-500 focus:ring-offset-cyan-200">
                            <label for="ingatkan" class="ml-2 block text-sm text-cyan-100">
                                Ingat saya
                            </label>
                        </div>

                        <a href="{{ route('password.request') }}" class="text-sm font-medium text-cyan-300 hover:text-white transition duration-300">
                            Lupa kata sandi?
                        </a>
                    </div>
                ...
                <div class="mt-8 text-center transform transition duration-500 item-form-masuk" style="transition-delay: 400ms">
                    <p class="text-cyan-100">
                        Belum memiliki akun?
                        <a href="{{ route('register') }}" class="font-medium text-cyan-300 hover:text-white transition duration-300">Buat akun baru</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <!-- Fakta Lautan -->
        <div class="mt-8 text-center transform transition duration-500 item-form-masuk bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
            <div class="flex items-start">
                ...
                <p class="text-sm text-cyan-100 text-left">
                    <span class="font-medium text-white">Fakta Lautan:</span> Lautan menghasilkan lebih dari setengah oksigen dunia dan menyerap 50 kali lebih banyak karbon dioksida daripada atmosfer kita.
                </p>
            </div>
        </div>
    </div>
