    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" action="{{ route('register') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="rounded-md shadow-sm space-y-4">
                ...
                <div>
                    <label for="foto_profil" class="block text-sm font-medium text-gray-700">Profile Photo (Optional)</label>
                ...
                <div>
                    ...
                    <textarea id="bio" name="bio" rows="3"
                        class="appearance-none relative block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm">{{ old('bio') }}</textarea>
                    @error('bio')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
