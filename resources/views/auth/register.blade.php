...
@section('title', 'Daftar - Portal Lautan Bagan')

@section('head')
<meta http-equiv="refresh" content="1800"> <!-- Refreshes page after 30 minutes -->
@endsection
    ...
    <div class="relative z-10 w-full max-w-md px-8 py-10">
        <div class="bg-white/10 backdrop-blur-xl rounded-3xl overflow-hidden shadow-2xl border border-white/20 transform transition-all hover:shadow-cyan-500/20 kartu-bercahaya">
            ...
            <div class="text-center pt-10 pb-6 px-8">
                ...
                <h2 class="text-3xl font-bold text-white mb-1 tracking-wide">Buat Akun Baru</h2>
                <p class="text-cyan-100 text-lg">Bergabunglah dengan komunitas lautan kami</p>
            </div>
            ...
            <div class="px-8 pt-6 pb-8">
                <form class="space-y-6" action="{{ route('register') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="kelompok-form transform transition duration-500 item-form-masuk">
                        <label for="name" class="block text-cyan-100 text-sm font-medium mb-2">Nama Lengkap</label>
                        <div class="relative">
                    ...
                    <div class="kelompok-form transform transition duration-500 item-form-masuk" style="transition-delay: 200ms">
                        <label for="password" class="block text-cyan-100 text-sm font-medium mb-2">Kata Sandi</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-cyan-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="kelompok-form transform transition duration-500 item-form-masuk" style="transition-delay: 300ms">
                    ...
                    <!-- Foto Profil -->
                    <div class="kelompok-form transform transition duration-500 item-form-masuk" style="transition-delay: 400ms">
                        <label for="foto_profil" class="block text-cyan-100 text-sm font-medium mb-2">Foto Profil (Opsional)</label>
                        <div class="flex items-center space-x-4">
                            <div class="w-16 h-16 rounded-full bg-white/10 border border-white/20 flex items-center justify-center overflow-hidden">
                                <svg class="h-8 w-8 text-cyan-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                </svg>
                                <img id="preview-foto" class="h-full w-full object-cover hidden" src="#" alt="Preview foto">
                            </div>
                            <div class="flex-1">
                                <label for="foto_profil" class="cursor-pointer flex items-center justify-center px-4 py-2.5 border border-white/20 rounded-xl bg-white/10 hover:bg-white/20 transition-all duration-300 text-cyan-100">
                    ...
                    <!-- Bio -->
                    <div class="kelompok-form transform transition duration-500 item-form-masuk" style="transition-delay: 500ms">
                        <label for="bio" class="block text-cyan-100 text-sm font-medium mb-2">Bio (Opsional)</label>
                        <div class="relative">
                            <div class="absolute top-3 left-3 flex-shrink-0 pointer-events-none">
                                <svg class="h-5 w-5 text-cyan-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg>
                            </div>
                            <textarea id="bio" name="bio" rows="3"
                                class="bg-white/10 block w-full pl-10 pr-3 py-3 rounded-xl border border-white/20 focus:ring-2 focus:ring-cyan-500 focus:border-transparent placeholder-cyan-200/50 text-white text-lg transition duration-300 input-bercahaya resize-none"
                    ...
                    <!-- Tombol Submit -->
                    <div class="transform transition duration-500 item-form-masuk" style="transition-delay: 600ms">
                ...
                <!-- Link Login -->
                <div class="mt-8 text-center transform transition duration-500 item-form-masuk" style="transition-delay: 700ms">
                    <p class="text-cyan-100">
                        Sudah memiliki akun?
                        <a href="{{ route('login') }}" class="font-medium text-cyan-300 hover:text-white transition duration-300">Masuk di sini</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <!-- Fakta Lautan -->
        <div class="mt-8 text-center transform transition duration-500 item-form-masuk bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10" style="transition-delay: 800ms">
            <div class="flex items-start">
                ...
                <p class="text-sm text-cyan-100 text-left">
                    <span class="font-medium text-white">Fakta Lautan:</span> Terumbu karang merupakan rumah bagi seperempat dari semua kehidupan laut meskipun hanya menutupi kurang dari 1% dasar laut.
                </p>
            </div>
        </div>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (fotoProfil && previewFoto) {
            fotoProfil.addEventListener('change', function(event) {
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        ...
                        previewFoto.previousElementSibling.classList.add('hidden'); // Hide the SVG icon
                    }
