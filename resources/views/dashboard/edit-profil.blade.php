        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('user.update-profile') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Tell the community about yourself.</p>
                    @error('bio')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex items-center justify-between">
                    <a href="{{ route('user.profile') }}" class="bg-gray-300 text-gray-700 hover:bg-gray-400 px-4 py-2 rounded-md text-sm font-medium transition duration-300">Cancel</a>
