...
<div class="min-h-screen bg-gradient-to-b from-cyan-50 via-blue-50 to-teal-50 relative overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        ...
        <!-- Added scrolling background image -->
    ...
    <div class="container mx-auto px-4 pt-32 pb-20 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            <div class="mb-8">
                <div class="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 mb-6 fade-in-up">
            ...
            <h1 class="text-6xl md:text-7xl font-bold mb-6 leading-tight words-reveal">
                <span class="word">Discover</span>
                <span class="word">the</span>
                <span class="gradient-text word">Deep Sea</span>
                <br>
                <span class="word">of</span>
                <span class="word">Wisdom</span>
            </h1>

            <p class="text-xl md:text-2xl mb-12 text-cyan-100 max-w-3xl mx-auto leading-relaxed fade-in-up delay-300">
    ...
    <div class="text-center p-8 bg-white/10 backdrop-blur-sm rounded-3xl border border-white/20 card-hover animate-on-scroll" data-counter-value="{{ $stats['publishedArticles'] }}">
    ...
    <div class="text-center p-8 bg-white/10 backdrop-blur-sm rounded-3xl border border-white/20 card-hover animate-on-scroll" data-counter-value="{{ $stats['activeUsers'] }}">
        ...
        <p class="text-cyan-100 font-medium">Active Community Members</p>
    </div>
    ...
    <div class="text-center p-8 bg-white/10 backdrop-blur-sm rounded-3xl border border-white/20 card-hover animate-on-scroll" data-counter-value="{{ $stats['funfactCount'] }}">
        ...
        <p class="text-cyan-100 font-medium">Ocean Facts Shared</p>
    </div>
        ...
        <div class="container mx-auto px-4 text-center relative z-10">
            <div class="max-w-4xl mx-auto animate-on-scroll">
                ...
                <p class="text-xl md:text-2xl mb-12 text-cyan-100 max-w-3xl mx-auto leading-relaxed text-reveal-delay-1">
                    Share your marine discoveries, connect with fellow ocean enthusiasts, and help create the worlds largest sea of knowledge
                </p>
                        ...
                        <form action="#" method="POST" class="space-y-4">
                            ...
                            <div class="flex items-center">
                                ...
                                <label for="newsletter" class="ml-3 text-sm text-gray-600">
                                    Id like to receive ocean conservation updates and exclusive content
                                </label>
                            </div>
    ...
    @if(auth()->user()->is_admin == true || auth()->user()->role == 'admin')
        <li><a href="{{ route('admin.edit-profile') }}" class="text-gray-400 hover:text-white transition-colors">My Profile</a></li>
    @else
        <li><a href="{{ route('user.edit-profile') }}" class="text-gray-400 hover:text-white transition-colors">My Profile</a></li>
    @endif
 @else
...
<style>
    ...
    .words-reveal .word:nth-child(1) { animation-delay: 0.2s; }
    .words-reveal .word:nth-child(2) { animation-delay: 0.4s; }
    .words-reveal .word:nth-child(3) { animation-delay: 0.6s; }
    .words-reveal .word:nth-child(4) { animation-delay: 0.9s; }
    .words-reveal .word:nth-child(5) { animation-delay: 1.1s; }
